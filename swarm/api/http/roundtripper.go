...
see https://github.com/themis-network/go-themis/issues/2040
Usage:

import (
 "github.com/themis-network/go-themis/common/httpclient"
 "github.com/themis-network/go-themis/swarm/api/http"
)

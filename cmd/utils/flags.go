...
// This file is part of go-themis.
//
// go-themis is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
// the Free Software Foundation, either version 3 of the License, or
// (at your option) any later version.
//
// go-themis is distributed in the hope that it will be useful,
// but WITHOUT ANY WARRANTY; without even the implied warranty of
// MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the
// GNU General Public License for more details.
//
// You should have received a copy of the GNU General Public License
// along with go-themis. If not, see <http://www.gnu.org/licenses/>.

// Package utils contains internal helper functions for go-themis commands.
package utils
...
import (
	...
	"github.com/themis-network/go-themis/common/fdlimit"
	"github.com/themis-network/go-themis/consensus"
	"github.com/themis-network/go-themis/consensus/clique"
	"github.com/themis-network/go-themis/consensus/ethash"
	...
	"github.com/themis-network/go-themis/dashboard"
	"github.com/themis-network/go-themis/eth"
	"github.com/themis-network/go-themis/eth/downloader"
	"github.com/themis-network/go-themis/eth/gasprice"
	"github.com/themis-network/go-themis/ethdb"
	"github.com/themis-network/go-themis/ethstats"
	"github.com/themis-network/go-themis/les"
	"github.com/themis-network/go-themis/log"
	"github.com/themis-network/go-themis/metrics"
	"github.com/themis-network/go-themis/metrics/influxdb"
	...
	"github.com/themis-network/go-themis/p2p/discv5"
	"github.com/themis-network/go-themis/p2p/nat"
	"github.com/themis-network/go-themis/p2p/netutil"
	"github.com/themis-network/go-themis/params"
	whisper "github.com/themis-network/go-themis/whisper/whisperv6"
...
func SetEthConfig(ctx *cli.Context, stack *node.Node, cfg *eth.Config) {
	...
	checkExclusive(ctx, DeveloperFlag, ThemisTestnetFlag)

...
import (
	...
	"github.com/themis-network/go-themis/signer/core"
	"github.com/themis-network/go-themis/signer/rules"
	"github.com/themis-network/go-themis/signer/storage"
...
func init() {
	app.Name = "Clef"
	app.Usage = "Manage Themis account operations"
	app.Flags = []cli.Flag{
		logLevelFlag,
		keystoreFlag,
		configdirFlag,

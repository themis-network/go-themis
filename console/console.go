...
import (
	...
	"github.com/themis-network/go-themis/internal/jsre"
	"github.com/themis-network/go-themis/internal/web3ext"
...
func (c *Console) Welcome() {
	...
	fmt.Fprintf(c.printer, "Welcome to the Gthemis JavaScript console!\n\n")
	c.jsre.Run(`

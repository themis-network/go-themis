...
//
// Detailed usage document and tutorial available on the go-themis Wiki page:
// https://github.com/themis-network/go-themis/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind
